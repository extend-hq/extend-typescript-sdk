...
<details><summary><code>client.workflows.<a href="/src/api/resources/workflows/client/Client.ts">listVersions</a>(id, { ...params }) -> Extend.WorkflowsListVersionsResponse</code></summary>
<dl>
<dd>
...
```typescript
await client.workflows.listVersions("workflow_abc123", {
    nextPageToken: "xK9mLPqRtN3vS8wF5hB2cQ==:zWvUxYjM4nKpL7aDgE9HbTcR2mAyX3/Q+CNkfBSw1dZ="
});
...
**request:** `Extend.WorkflowsListVersionsRequest` 
...
<details><summary><code>client.workflows.<a href="/src/api/resources/workflows/client/Client.ts">deploy</a>(id, { ...params }) -> Extend.WorkflowVersion</code></summary>
<dl>
<dd>
...
```typescript
await client.workflows.deploy("workflow_abc123");
...
**request:** `Extend.WorkflowsDeployRequest` 
...
<details><summary><code>client.workflows.<a href="/src/api/resources/workflows/client/Client.ts">retrieveVersion</a>(id, versionId) -> Extend.WorkflowVersion</code></summary>
<dl>
<dd>
...
```typescript
await client.workflows.retrieveVersion("workflow_abc123", "draft");
