...
export const PostProcessorsIdRequestConfig: core.serialization.Schema<
    serializers.PostProcessorsIdRequestConfig.Raw,
    Extend.PostProcessorsIdRequestConfig
> = core.serialization
    .union("type", {
    ...
    .transform<Extend.PostProcessorsIdRequestConfig>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace PostProcessorsIdRequestConfig {
    export type Raw =
        | PostProcessorsIdRequestConfig.Classify
        | PostProcessorsIdRequestConfig.Extract
        | PostProcessorsIdRequestConfig.Splitter;
