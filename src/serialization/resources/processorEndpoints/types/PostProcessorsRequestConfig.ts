...
export const PostProcessorsRequestConfig: core.serialization.Schema<
    serializers.PostProcessorsRequestConfig.Raw,
    Extend.PostProcessorsRequestConfig
> = core.serialization
    .union("type", {
    ...
    .transform<Extend.PostProcessorsRequestConfig>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace PostProcessorsRequestConfig {
    export type Raw =
        | PostProcessorsRequestConfig.Classify
        | PostProcessorsRequestConfig.Extract
        | PostProcessorsRequestConfig.Splitter;
