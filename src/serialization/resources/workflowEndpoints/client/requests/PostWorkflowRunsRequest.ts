...
export const PostWorkflowRunsRequest: core.serialization.Schema<
    serializers.PostWorkflowRunsRequest.Raw,
    Extend.PostWorkflowRunsRequest
...
export declare namespace PostWorkflowRunsRequest {
