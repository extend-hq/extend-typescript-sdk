...
export const ExtractConfigLegacyBaseProcessor = {
    ExtractionPerformance: "extraction_performance",
    ExtractionLight: "extraction_light",
} as const;
export type ExtractConfigLegacyBaseProcessor =
    | (typeof ExtractConfigLegacyBaseProcessor)[keyof typeof ExtractConfigLegacyBaseProcessor]
    | string;
