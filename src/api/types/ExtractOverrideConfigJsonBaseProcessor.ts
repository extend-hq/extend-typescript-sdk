...
export const ExtractOverrideConfigJsonBaseProcessor = {
    ExtractionPerformance: "extraction_performance",
    ExtractionLight: "extraction_light",
} as const;
export type ExtractOverrideConfigJsonBaseProcessor =
    | (typeof ExtractOverrideConfigJsonBaseProcessor)[keyof typeof ExtractOverrideConfigJsonBaseProcessor]
    | string;
