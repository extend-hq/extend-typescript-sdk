...
export interface LegacyBatchProcessorRun {
    ...
    metrics: Extend.LegacyBatchProcessorRunMetrics;
    /**
     ...
     */
    status: Extend.LegacyBatchProcessorRunStatus;
    /**
     ...
     */
    source: Extend.LegacyBatchProcessorRunSource;
    /**
    ...
    options: Extend.LegacyBatchProcessorRunOptions;
    /**
