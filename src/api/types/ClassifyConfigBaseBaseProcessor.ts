...
export const ClassifyConfigBaseBaseProcessor = {
    ClassificationPerformance: "classification_performance",
    ClassificationLight: "classification_light",
} as const;
export type ClassifyConfigBaseBaseProcessor =
    | (typeof ClassifyConfigBaseBaseProcessor)[keyof typeof ClassifyConfigBaseBaseProcessor]
    | string;
