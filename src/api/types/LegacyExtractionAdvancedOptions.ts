...
export interface LegacyExtractionAdvancedOptions {
    ...
    arrayCitationStrategy?: Extend.LegacyExtractionAdvancedOptionsArrayCitationStrategy;
    ...
    chunkingOptions?: Extend.LegacyExtractChunkingOptions;
