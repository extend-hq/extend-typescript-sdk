...
export const SplitConfigBaseBaseProcessor = {
    SplittingPerformance: "splitting_performance",
    SplittingLight: "splitting_light",
} as const;
export type SplitConfigBaseBaseProcessor =
    | (typeof SplitConfigBaseBaseProcessor)[keyof typeof SplitConfigBaseBaseProcessor]
    | string;
