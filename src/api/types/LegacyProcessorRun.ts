...
export interface LegacyProcessorRun {
     ...
     */
    output: Extend.LegacyProcessorOutput;
    ...
    edited: boolean;
    edits: Record<string, Extend.LegacyExtractionOutputEdits>;
    /**
    ...
    mergedProcessors: Extend.LegacyProcessorRunMergedProcessorsItem[];
