...
export const ClassificationBaseProcessor = {
    ClassificationPerformance: "classification_performance",
    ClassificationLight: "classification_light",
} as const;
export type ClassificationBaseProcessor =
    | (typeof ClassificationBaseProcessor)[keyof typeof ClassificationBaseProcessor]
    | string;
