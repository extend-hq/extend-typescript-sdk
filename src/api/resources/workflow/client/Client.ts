...
export class Workflow {
    ...
    private async __create(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.WorkflowCreateRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
        ...
        if (_response.ok) {
            return {
                data: serializers.WorkflowCreateResponse.parseOrThrow(_response.body, {
