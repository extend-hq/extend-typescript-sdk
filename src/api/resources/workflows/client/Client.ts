...
export class WorkflowsClient {
     ...
     *
     * @param {string} id - The ID of the workflow.
     * @param {Extend.WorkflowsListVersionsRequest} request
     * @param {WorkflowsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Extend.BadRequestError}
     * @throws {@link Extend.UnauthorizedError}
    ...
    public listVersions(
        ...
        requestOptions?: WorkflowsClient.RequestOptions,
    ): core.HttpResponsePromise<Extend.WorkflowsListVersionsResponse> {
        return core.HttpResponsePromise.fromPromise(this.__listVersions(id, request, requestOptions));
    }
    ...
    private async __listVersions(
        ...
        request: Extend.WorkflowsListVersionsRequest = {},
        requestOptions?: WorkflowsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Extend.WorkflowsListVersionsResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Extend.WorkflowsListVersionsResponse, rawResponse: _response.rawResponse };
        }
     ...
     * @param {Extend.WorkflowsDeployRequest} request
     * @param {WorkflowsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Extend.BadRequestError}
     * @throws {@link Extend.UnauthorizedError}
    ...
    public deploy(
        ...
        return core.HttpResponsePromise.fromPromise(this.__deploy(id, request, requestOptions));
    }
    ...
    public retrieveVersion(
        ...
        return core.HttpResponsePromise.fromPromise(this.__retrieveVersion(id, versionId, requestOptions));
    }

    private async __retrieveVersion(
        id: string,
        versionId: string,
        requestOptions?: WorkflowsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Extend.WorkflowVersion>> {
