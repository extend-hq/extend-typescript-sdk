...
export class EvaluationSetEndpoints {
    ...
    private async __createEvaluationSet(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.PostEvaluationSetsRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
        ...
        if (_response.ok) {
            return {
                data: serializers.PostEvaluationSetsResponse.parseOrThrow(_response.body, {
    ...
    private async __createEvaluationSetItem(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.PostEvaluationSetItemsRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        if (_response.ok) {
            return {
                data: serializers.PostEvaluationSetItemsResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    breadcrumbsPrefix: ["response"],
    ...
    private async __updateEvaluationSetItem(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.PostEvaluationSetItemsIdRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        if (_response.ok) {
            return {
                data: serializers.PostEvaluationSetItemsIdResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    breadcrumbsPrefix: ["response"],
    ...
    private async __bulkCreateEvaluationSetItems(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.PostEvaluationSetItemsBulkRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
            }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
        ...
        if (_response.ok) {
            return {
                data: serializers.PostEvaluationSetItemsBulkResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    breadcrumbsPrefix: ["response"],
