...
export class Processor {
    ...
    private async __create(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.ProcessorCreateRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
        ...
        if (_response.ok) {
            return {
                data: serializers.ProcessorCreateResponse.parseOrThrow(_response.body, {
    ...
    private async __update(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.ProcessorUpdateRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        if (_response.ok) {
            return {
                data: serializers.ProcessorUpdateResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    breadcrumbsPrefix: ["response"],
