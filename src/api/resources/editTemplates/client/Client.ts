...
export class EditTemplatesClient {
    ...
    ): core.HttpResponsePromise<Extend.EditTemplate> {
    ...
    private async __retrieve(
        ...
        request: Extend.EditTemplatesRetrieveRequest = {},
        requestOptions?: EditTemplatesClient.RequestOptions,
    ): Promise<core.WithRawResponse<Extend.EditTemplate>> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `edit_templates/${core.url.encodePathParam(id)}`,
            ),
            method: "GET",
            headers: _headers,
        ...
        if (_response.ok) {
            return { data: _response.body as Extend.EditTemplate, rawResponse: _response.rawResponse };
        }
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/edit_templates/{id}");
    }
}
