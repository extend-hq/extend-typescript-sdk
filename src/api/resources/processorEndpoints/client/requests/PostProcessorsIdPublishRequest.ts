 ...
 *     }
 */
export interface PostProcessorsIdPublishRequest {
    ...
    releaseType: Extend.PostProcessorsIdPublishRequestReleaseType;
    ...
    config?: Extend.PostProcessorsIdPublishRequestConfig;
}
