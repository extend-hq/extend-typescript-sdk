...
describe("EvaluationSetItems", () => {
    test("list (1)", async () => {
        ...
        const rawResponseBody = {
            evaluationSetItems: [
                {
                    object: "evaluation_set_item_summary",
    ...
    test("create (2)", async () => {
        ...
        const rawRequestBody = {
            items: [
                { fileId: "fileId", expectedOutput: { value: undefined } },
                { fileId: "fileId", expectedOutput: { value: undefined } },
            ],
        };
        const rawResponseBody = { key: "value" };
    ...
    test("update (2)", async () => {
        const server = mockServerPool.createServer();
        const client = new ExtendClient({ token: "test", environment: server.baseUrl });
        const rawRequestBody = { expectedOutput: { value: undefined } };
        const rawResponseBody = { key: "value" };
        server
            .mockEndpoint()
