...
describe("WorkflowVersionsClient", () => {
    test("list (1)", async () => {
        ...
        const response = await client.workflowVersions.list("workflow_abc123", {
            nextPageToken: "xK9mLPqRtN3vS8wF5hB2cQ==:zWvUxYjM4nKpL7aDgE9HbTcR2mAyX3/Q+CNkfBSw1dZ=",
        });
    ...
    test("list (2)", async () => {
        ...
        await expect(async () => {
            return await client.workflowVersions.list("id");
    ...
    test("create (1)", async () => {
        ...
        const response = await client.workflowVersions.create("workflow_abc123");
        expect(response).toEqual({
            object: "workflow_version",
            id: "workflow_version_Zk9mNP12Qw4-yTv8BdR3H",
            version: "1",
    ...
    test("create (2)", async () => {
        ...
        await expect(async () => {
            return await client.workflowVersions.create("id");
        }).rejects.toThrow(Extend.BadRequestError);
    });
    ...
    test("retrieve (1)", async () => {
        ...
        const response = await client.workflowVersions.retrieve("workflow_abc123", "draft");
        expect(response).toEqual({
            object: "workflow_version",
            id: "workflow_version_Zk9mNP12Qw4-yTv8BdR3H",
            version: "1",
    ...
    test("retrieve (2)", async () => {
        ...
        await expect(async () => {
            return await client.workflowVersions.retrieve("id", "versionId");
        }).rejects.toThrow(Extend.BadRequestError);
    });
