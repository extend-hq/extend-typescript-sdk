...
[![npm shield](https://img.shields.io/npm/v/extendsdk)](https://www.npmjs.com/package/extendsdk)
...
```typescript
import { ExtendClient } from "extendsdk";
...
```typescript
import { ExtendError } from "extendsdk";
